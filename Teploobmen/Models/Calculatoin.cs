...
namespace Teploobmen.Models
{
    public class Calculatoin
    {
        ...
        private List<double> prList = new List<double>() { 0.71, 0.7, 0.69, 0.68, 0.68, 0.34, 0.45, 0.68, 0.68, 0.345, 0.46, 0.69, 0.7, 0.3525, 0.3575, 0.53875, 0.71, 0.715, 0.72, 0.72, 0.72 };//Прансель
